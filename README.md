...
2) Install Python if needed. This project is created on Python 3.9. Minor incompatibility issues may occur in other versions
3) Create a virtual environment in your working directory and run the command:
